...
object ConstantsConverter {
    ...
    val constantsConvertsData: Array<Triple<Int, Int, Int>> by lazy {
        arrayOf(
            ...
            Triple(
                R.string.label_temperatureText,
                R.string.tooltip_temperatureText,
            ...
            Triple(
                R.string.label_frequencyText,
                R.string.tooltip_frequencyText,
                R.array.frequency_units
            ),
            Triple(
                R.string.label_fuelConsumptionText,
                R.string.tooltip_fuelConsumptionText,
                R.array.fuelConsumption_units
            ),
            Triple(
                R.string.label_pressureText,
                R.string.tooltip_fuelConsumptionText,
                R.array.pressure_units
            ),
    ...
    val constantsMathData: Array<Array<Int>> by lazy {
        arrayOf(
    ...
    private val weightConvert : Array<Array<Double>> by lazy {
        arrayOf(
    ...
    private val lengthConvert: Array<Array<Double>> by lazy {
        arrayOf(
    ...
    private val speedConvert: Array<Array<Double>> by lazy {
            arrayOf(
    ...
    private val dataConvert: Array<Array<Double>> by lazy { arrayOf(
    ...
    private val temperatureConvert: Array<Array<Double>> by lazy { arrayOf(
    ...
    private val volumeConvert: Array<Array<Double>> by lazy { arrayOf(
    ...
    private val areaConvert: Array<Array<Double>> by lazy { arrayOf(
    ...
    private val frequencyConvert: Array<Array<Double>> by lazy { arrayOf(
    ...
    private val fuelConsumptionConvert: Array<Array<Double>> by lazy { arrayOf(
    ...
    private val pressureConvert: Array<Array<Double>> by lazy { arrayOf(
        //    Атмосфер      Бар           Паскаль
        arrayOf(1.0,        (1 / 1.013),   (1 / 101325.0)), // Атмосфер
        arrayOf(1.013,      1.0,           (1 / 1e5)),      // Бар
        arrayOf(101325.0,   1e5,           1.0)             // Паскаль
    )}
    private val powerConvert: Array<Array<Double>> by lazy { arrayOf(
    ...
    private val energyConvert: Array<Array<Double>> by lazy { arrayOf(
    ...
    val CONVERTERS: List<Array<Array<Double>>> by lazy {
        listOf(
            weightConvert,
            lengthConvert,
            speedConvert,
